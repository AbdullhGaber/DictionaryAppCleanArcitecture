...
import com.example.dictionaryapp.feature_dictionary.presentation.wordInfo.WordInfoViewModel
                ...
                Scaffold(
                    ...
                    Column(Modifier.fillMaxSize().padding(innerPadding)){
                        ...
                        LazyColumn(
                            ...
                            items(viewModel.wordInfo.value.wordInfos.size){ index ->
                                val wordInfo = viewModel.wordInfo.value.wordInfos[index]
                                if(index > 0){
                                    Spacer(Modifier.height(8.dp))
                                }
                                WordInfoItem(wordInfo = wordInfo)
                                if(index < viewModel.wordInfo.value.wordInfos.size - 1){
                                    HorizontalDivider()
                                }
                            }
                        }
